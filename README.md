...
- Core features of Node.js is that it allows us to use javascript in both the client and server which simplifies things, it also allows us to run functions async. Lastly, it grants us access to the NPM package universe. Core features of express are its simplicity, extensibility, and light footprint.

2. Understand and explain the use of Middleware.

- Middleware can best custom built, built-in, third-party. You enable middleware making a .use() call on our server and passing our middleware inside of it. Middleware extends the functionality of an express app such as logging or validation of requests.

3. The basic principles of the REST architectural style.

- The basic principles of the REST architectural style are everything in a resource, each resource is available via a unique URI, communication happens over a a stateless protocol (HTTP), and HTTP methods handle resource management.

4. Understand and explain the use of Express Routers.

- Express routers allow compartmentalization of methods functioning on different types of objects, for example, a router for project methods, and another router for actions. This allows for simplicity. 

5. Describe tooling used to manually test the correctness of an API.

- To manually test the correctness of an API, you need to use postman, HTTPie, or Insomnia, these tools allow you to manually hit the different methods (get, post, put, delete) of your API with request bodies that test different edge cases. 